...
#                  Last modification: 20/01/2025 (short communication)                     #
#------------------------------------------------------------------------------------------#



# Note: *** will notify the new sections added to the code (not present in the original paper code)
...
metric_graph <- function(metrics_list, n_data, names_methods, color_methods,
  ...
  # save graph
  my_path <- paste('3_output/', case_study_name, '/boxplot_', g_name, '.png', sep = '')
  ...
  # save graph
  my_path <- paste('3_output/', case_study_name, '/boxplot_density_', g_name, '.png', sep = '')
  ggsave(filename = my_path, device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)
  ...
  # save graph
  my_path <- paste('3_output/', case_study_name, '/density_all_', g_name, '.png', sep = '')
  ggsave(filename = my_path, device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)
  ...
  # save graph
  my_path <- paste('3_output/', case_study_name, '/density_split_', g_name, '.png', sep = '')
  ggsave(filename = my_path, device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)
}
...
time_graph <- function(my_timer_general, my_order, case_study_name){
  ...
  # save graph
  my_path <- paste('3_output/', case_study_name, '/time_analysis.png', sep = '')
  ggsave(filename = my_path, device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)
}
...
graph_best_model <- function(best_compilation, case_study_name){
  ...
  # save graph
  my_path <- paste('3_output/', case_study_name, '/best_model_all_metrics.png', sep = '')
  ggsave(filename = my_path, device = 'png', units = 'mm', dpi = 300, width = 300, height = 300)
}
